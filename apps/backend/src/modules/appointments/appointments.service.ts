  ...
  async create(body: Record<string, unknown>) {
    const row = await this.prisma.appointment.create({
      data: {
        ...
        vendorEmail: body.vendorEmail ? String(body.vendorEmail) : null,
  ...
  async update(id: string, body: Record<string, unknown>) {
    const row = await this.prisma.appointment.update({
      ...
      data: {
        ...
        vendorName: body.vendorName !== undefined ? (body.vendorName ? String(body.vendorName) : null) : undefined,
        vendorEmail: body.vendorEmail !== undefined ? (body.vendorEmail ? String(body.vendorEmail) : null) : undefined,
