...
export default function NewAppointment() {
  ...
  async function handleServiceOrderImport(file?: File | null) {
    ...
    try {
      ...
      setFormData((prev) => ({
        ...prev,
        companyName: fields.clientName || prev.companyName,
        cnpj: fields.clientCnpj || prev.cnpj,
        ie: fields.clientIe || prev.ie,
        phone: fields.clientPhone || prev.phone,
        email: fields.clientEmail || prev.email,
        city: fields.clientCity || prev.city,
        state: fields.clientState || prev.state,
        district: fields.clientDistrict || prev.district,
        zipCode: fields.clientZipCode || prev.zipCode,
        address: fields.clientAddress || prev.address,
      ...
      toast.success(result.aiUsed ? 'OS analisada com IA.' : 'Dados da OS importados.');
    } catch (err) {
              ...
              <div>
                ...
                {shouldShowLogisticsStatus && (
                  <div className={`mt-3 rounded-lg border p-3 text-sm ${
                    ...
                    <p className="font-medium text-white">Sugestao de viagem</p>
                    {travelLoading && (
                      <p className="mt-1 text-xs text-zinc-300">O sistema esta calculando automaticamente se a viagem deve ser de carro ou de aviao.</p>
                    )}
                ...
                <div className="rounded-lg border border-blue-500/20 bg-blue-500/5 p-3">
                  <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                    <div>
                      ...
                      <p className="text-xs text-zinc-400">Anexe o PDF original para a IA separar servico, equipamento e relato nos campos corretos.</p>
                    </div>
